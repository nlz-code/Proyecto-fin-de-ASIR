...
<body style="padding-top: 70px;"> <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="../index.html">Mobility Alliance</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="index.php">Taxistas</a></li>
    ...
    <div class="container mt-4">
        <h1>Taxistas disponibles en estos momentos</h1>
        <p>Aquí aparecerá la lista de conductores...</p>
    </div>
